...
OWASP_CATEGORIES = {
    "BOLA": {"name": "Broken Object Level Authorization", "owasp_id": "API1:2023", "pci_req": ["6.2.4", "6.3.1"]},
    "BROKEN_AUTH": {"name": "Broken Authentication", "owasp_id": "API2:2023", "pci_req": ["8.2.1", "8.3.1"]},
    "BROKEN_OBJECT_PROPERTY": {"name": "Broken Object Property Level Authorization", "owasp_id": "API3:2023", "pci_req": ["6.2.4"]},
    "UNRESTRICTED_RESOURCE": {"name": "Unrestricted Resource Consumption", "owasp_id": "API4:2023", "pci_req": ["6.4.1"]},
    "BFLA": {"name": "Broken Function Level Authorization", "owasp_id": "API5:2023", "pci_req": ["6.2.4", "7.1.1"]},
    "UNRESTRICTED_ACCESS": {"name": "Unrestricted Access to Sensitive Business Flows", "owasp_id": "API6:2023", "pci_req": ["6.4.2"]},
    "SSRF": {"name": "Server Side Request Forgery", "owasp_id": "API7:2023", "pci_req": ["6.2.4"]},
    "SECURITY_MISCONFIGURATION": {"name": "Security Misconfiguration", "owasp_id": "API8:2023", "pci_req": ["2.2.1", "6.2.4"]},
    "IMPROPER_INVENTORY": {"name": "Improper Inventory Management", "owasp_id": "API9:2023", "pci_req": ["6.3.2", "12.3.1"]},
    "UNSAFE_API_CONSUMPTION": {"name": "Unsafe Consumption of APIs", "owasp_id": "API10:2023", "pci_req": ["6.2.4"]},
}
...
def calculate_security_score(vulnerabilities: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    # Normalize: max possible weight per endpoint = 10 critical issues = 10.0
    # Score = 100 - (total_weight / max_weight * 100), clamped to [0, 100]
