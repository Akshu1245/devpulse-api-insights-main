"""Script to fix the error_handler.py file."""
...
with open("backend/services/error_handler.py", "w", encoding="utf-8") as f:
    f.write(content)
...
# Verify it parses
import ast
with open("backend/services/error_handler.py", "r", encoding="utf-8") as f:
    src = f.read()
ast.parse(src)
print("Syntax OK")
content = '''from __future__ import annotations
